...
3.  **Linear Algebra (focusing on linear structures):**
    * Vectors: Objects that can be added and scaled.
    * [[Linear Space|vector space]] is algebraic structure that consists of sets of vectors with operations satisfying certain axioms.
...
4.  **Metric Spaces (adding distance):**
    ...
    * This blends algebra with [[Analysis Overview | analysis]].
